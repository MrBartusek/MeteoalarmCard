...
| `show_warning_times` | `boolean` | `false` | _[Supported integrations only]_ Show the warning period in the top-right caption. Expected warnings show their start time; active warnings show their end time. |
